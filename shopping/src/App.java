public class App {
    public static void main(String[] args) throws Exception {
		...
		System.out.println(loja1.getSalarioBaseFuncionarios() == -1 ? "[OK] Método Loja.getSalarioBaseFuncionario()" : "[NOK] Método Loja.getSalarioBaseFuncionario()");

		//public void setSalarioBaseFuncionario(double salarioBaseFuncionario);
		loja1.setSalarioBaseFuncionarios(3000);
		...
		System.out.println(e1.getNomeRua().equals("Bla") ? "[OK] Método Endereco.getNomeDaRua()" : "[NOK] Método Endereco.getNomeDaRua()");
		...
		System.out.println(d1.isBissexto() ? "[OK] Método Dia.verificaAnoBissexto()" : "[NOK] Método Dia.verificaAnoBissexto()");
